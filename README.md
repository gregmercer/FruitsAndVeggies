...
To use this branch you'll need to git clone the MvvmCross project into the root folder. So the directory structure should look like this (after cloning MvvmCross):
